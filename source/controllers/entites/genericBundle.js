irfUiFormEngine.directive("genericBundle",function(){
   return {
      restrict : "AE",
      scope :{
          config : "=",
      ...
      template: 'bower_components/irf-ui-form-engine/source/templates/entites/GenericLead.html'
  }
}).controller("genericBundleCtrl",["$scope","PageHelper",function($scope,PageHelper){
